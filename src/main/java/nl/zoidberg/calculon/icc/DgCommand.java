...
public enum DgCommand {
    ...
    public static DgCommand valueOf(int commandNumber) {
        for(DgCommand dgCommand: DgCommand.values()) {
            if(dgCommand.getCommandNumber() == commandNumber) {
                return dgCommand;
            }
        }
        return null;
