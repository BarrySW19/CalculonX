...
import nl.zoidberg.calculon.engine.ClockStatus;
...
public class ICCInterface {
    ...
    private class ClockUpdateHandler implements BlockHandler {
        ...
        @Override
        public boolean accept(ResponseBlockLv2 responseBlock) {
            if(responseBlock.getCommand() != DgCommand.DG_MSEC) {
                return false;
            }
            return Integer.parseInt(responseBlock.tokenize()[1]) == gameNumber;
        }
