...
public class ProblemsInPlayTest {
    ...
    private void runTest(String fen, String pgn) throws InterruptedException {
        ...
        AnalyseWindow.openWindow(engine.getPreferredMoveContext(board));
